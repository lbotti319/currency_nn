...
def plot_multi_scale(xlabel,x,y_left,ylabel_left,c_left='b',legend_left=None, log_left=False,
                     y_right=None,ylabel_right=None,c_right='orange',legend_right=None, log_right=False):
    plots = []
    fig, ax1 = plt.subplots()
    if log_left: ax1.set_yscale("log")
    ...
    if y_right is not None:
        ...
        if log_left: ax2.set_yscale("log")
...
def plot_train_test(train,test):
    ...
    plot_multi_scale('epochs',x,y_left=yl,ylabel_left='cost',c_left=cl,legend_left=legl,log_left=False,
                         y_right=yr,ylabel_right='accuracy',c_right=cr,legend_right=legr,log_right=False)